...
Text box----------Input Text, clear text,
Button -----------Click
Icon/image--------Click, drag and drop
dropdown----------Select 
window title------View/check
loading box-------View/check
check box---------Click
popup/modal/browser window
iFrame
Graph/SVG
Flash-----NA
windows pop up-----NA
Scrolldown --------mouse over
Highlight----------


Actions:
1.Launch Browser
2.Text box----------Input Text, clear text, read/get text.
3.Button -----------Click
4.Icon/image--------Click
5.dropdown----------Select 
6.window title------View/check
7.loading box-------View/check
8.check box---------Click
9.text.-------------read/get text.